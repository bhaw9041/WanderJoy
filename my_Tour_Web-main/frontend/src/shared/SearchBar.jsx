...
const SearchBar = () => {
    ...
    const searchHandler = async() => {
        ...
        {
            return alert('All fields(location, distance, max people) are required!');
        }
    ...
    return <Col lg='12'>
        <div className="search__bar">
            <Form className='d-flex align-items-center gap-4'>
                ...
                <FormGroup className='d-flex gap-3 form__group form__group-fast'>
                    <span>
                    <i class="ri-pin-distance-line"></i></span>
                    <div>
                        <h6>Distance</h6>
                ...
                <FormGroup className='d-flex gap-3 form__group form__group-last'>
                    ...
                    <div>
                        <h6>Max People</h6>
                        <input type="number" placeholder='0' ref={maxGroupSizeRef} min={0} max={8}/>
                    </div>
